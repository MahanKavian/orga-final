...
export function DealOfWeekCard({data}: Props) {
    ...
    return (
        <div className={"w-[330px] flex flex-col gap-5"}>
            <div className={"w-[310px] h-[310px] relative flex justify-center items-center border-b-2"}>
                <ImageView src={data.image} alt={data.title} width={258} height={258} />
                <div className={"bg-primary-300 text-white font-medium text-lg py-2 px-8 rounded-lg shadow-md flex items-center gap-3 absolute -bottom-[20px]"}>
