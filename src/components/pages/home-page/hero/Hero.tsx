import {CategoriesMenu, HeroFooter, IconBox, ImageView, Section} from "@/components";
    ...
    return (
        <div className="bg-silver-100 py-2 lg:py-4">
            <Section className="flex gap-4 justify-between mx-auto max-h-[580px] overflow-hidden">
                ...
                <div className="w-[31.7%] xl:w-[25.2%] max-w-[343px] flex-grow flex-shrink-0 hidden lg:flex flex-col gap-3.5">
                    {
