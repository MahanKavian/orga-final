...
export function ShopByCategory({}: Props) {
    return (
        <section className="bg-cream">
            <Section className="py-10 px-2 flex flex-col items-center lg:pb-20">
                <h3 className="font-lobster font-medium font-Jost text-heading2 text-silver-500 mb-10">
                    Shop By Categories
                </h3>
                <div className="w-full flex flex-wrap gap-3 justify-center lg:gap-6">
                    {
                        shopByCategory.map((item, index) => {
                            return (
                                <Link href="#"
                                      className="relative flex flex-col justify-end items-center hover:shadow-xl transition duration-500  md:w-[270px]">
