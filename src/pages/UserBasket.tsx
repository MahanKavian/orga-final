        ...
        <>
            ...
            <Section className="py-4">
                <ul className="w-full flex flex-col">
                    <li className="grid grid-cols-8 gap-3 items-center md:text-xl font-[500] text-black border-y-[1px] border-t-white border-b-gray-500 py-1 lg:py-4">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start md:justify-between py-4 md:py-8 border-t-[1px] border-t-gray-500">
                    <div className="flex gap-4">
                        <button className="text-black bg-gray-300 h-fit p-2 px-4 text-sm font-[500] tracking-[2px] hover:brightness-95 transition">UPDATE CARD</button>
                        <button className="text-black bg-gray-300 h-fit p-2 px-4 text-sm font-[500] tracking-[2px] hover:brightness-95 transition">CONTINUE SHOPING</button>
                    </div>
                    <div className="bg-gray-300 w-[350px] flex flex-col p-4 gap-8">
