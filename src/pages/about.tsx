import {CommentSlider, IconBox, ImageView, Rating, Section} from "@/components";
    ...
    return (
        <div className="w-full mb-[50px] py-10">
            <Section className="flex flex-col gap-16 p-2 md:py-2 md:px-0 mb-20">
                <div className="w-full flex flex-col items-center gap-5 bg-silver-100 py-10 lg:flex-row">
                    ...
                    <div
                        ...
                        <h3 className="font-lobster font-[500] text-silver-500 text-2xl md:text-4xl">Welcome to Organic
                            Store!</h3>
            ...
            <div className="container mx-auto flex flex-col gap-12 items-center">
                ...
                <div className="w-full flex items-center justify-center md:justify-between flex-wrap gap-8 lg:gap-0">
                    {
                        aboutTeamMember.map((item, index) => {
                            return (
                                <div className="flex flex-col gap-3 items-center" key={index}>
                                    <div className="w-[210px] h-[210px] flex items-center justify-center rounded-full overflow-hidden">
